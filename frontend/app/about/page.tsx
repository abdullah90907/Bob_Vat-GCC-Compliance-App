            ...
            <div>
              ...
              <div style={{ background: "#f8fafc", padding: "32px", borderRadius: "16px", border: "1px solid var(--border)" }}>
                ...
                <div style={{ marginTop: "24px", textAlign: "center" }}>
                  <a href="https://anique-1-bobvat-backend.hf.space/api/bob-demo" target="_blank" rel="noopener noreferrer" className="btn btn-outline-white" style={{ background: "var(--text-dark)", color: "white" }}>
